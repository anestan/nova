...
class wcva_register_style_scripts {
   ...
   public function wcva_register_my_scripts() {
     global $post,$product;
	   ...
	   $wcva_outofstock_options_behavior    = get_option('wcva_outofstock_options_behavior','01');
    ...
    if (($displaytypenumber >0) && ($goahead == 1) ) {
	   ...
	   wp_register_script( 'product-frontend', wcva_PLUGIN_URL . 'js/product-frontend.js' ,array( 'jquery','powerTip'), false, true);

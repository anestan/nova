jQuery(function ($) {
    ...
    var WindowLoadScripts = function(){
    ...
    var WpaProductGallery = function(){
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/wpa-woocommerce-product-images.default', WindowLoadScripts);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/wpa-woocommerce-product-images.default', WpaProductGallery);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/wpa-woocommerce-product-images.default', WpaMagnificPopup);
        elementorFrontend.hooks.addAction( 'frontend/element_ready/wpa-woocommerce-product-images.default', WpaZoom);
    });
});